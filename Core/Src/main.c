...
void BitBangPWM_Init_1()
{
    ...
    GPIO_InitStruct.Pin = PWM1_Pin; // Replace with your desired pin
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
...
void BitBangPWM_Init_2()
{
    ...
    GPIO_InitTypeDef GPIO_InitStruct;
    GPIO_InitStruct.Pin = PWM2_Pin; // Replace with your desired pin
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
...
//	 consider using toggle func here
	HAL_GPIO_TogglePin(GPIOB, PWM1_Pin); //Toggle the state of pin PC9
